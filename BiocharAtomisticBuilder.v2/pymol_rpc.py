...
class pymol_jupyter_builder:
    ...
    def refresh_model(self):
        ...
        self.server.do('color green,  elem F')
        self.server.do('color brown,  elem P')
    ...
    def Attach_C2H4CH3(self,object1,h_index):
        ...
        self.server.do('select at2, %s & name %s' % ('propane', 'H6'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'propane')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
    ...
    def Attach_propene(self,object1,h_index):
        self.server.do('select at1, %s & index %s' % (object1, h_index))
        self.server.do('load ./functional_groups/propene.mol2')
        self.server.do('select at2, %s & name %s' % ('propene', 'H6'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'propene')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
    ...
    def Attach_C4H4(self,object1,h_index):
        self.server.do('select at1, %s & index %s' % (object1, h_index))
        self.server.do('load ./functional_groups/C4H6.mol2')
        self.server.do('select at2, %s & name %s' % ('C4H6', 'H4'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'C4H6')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
    ...
    def Attach_SO3H(self,object1,h_index):
        self.server.do('select at1, %s & index %s' % (object1, h_index))
        self.server.do('load ./functional_groups/SO3H.mol2')
        self.server.do('select at2, %s & name %s' % ('SO3H', 'H1'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'SO3H')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
    ...
    def Attach_phosphate(self,object1,h_index):
        self.server.do('select at1, %s & index %s' % (object1, h_index))
        self.server.do('load ./functional_groups/OPO3.mol2')
        self.server.do('select at2, %s & name %s' % ('OPO3', 'H01'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'OPO3')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
    ...
    def Attach_phosphite(self,object1,h_index):
        self.server.do('select at1, %s & index %s' % (object1, h_index))
        self.server.do('load ./functional_groups/PO3.mol2')
        self.server.do('select at2, %s & name %s' % ('PO3', 'H01'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'PO3')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
    ...
    def Attach_phosphine(self,object1,h_index):
        self.server.do('select at1, %s & index %s' % (object1, h_index))
        self.server.do('load ./functional_groups/PH3.mol2')
        self.server.do('select at2, %s & name %s' % ('PH3', 'H01'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'PH3')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
    ...
    def Attach_Fluorine(self,object1,h_index):
        self.server.do('select at1, %s & index %s' % (object1, h_index))
        self.server.do('load ./functional_groups/fluorine.mol2')
        self.server.do('select at2, %s & name %s' % ('fluorine', 'H01'))
        self.server.do('edit at2, at1')
        self.server.do('fuse')
        self.server.do('unpick')
        self.server.do('delete at1')
        self.server.do('delete at2')
        self.server.do('delete %s' % 'fluorine')
        self.server.do('rebuild all')
        self.server.do('zoom %s' % object1)
        self.server.do('clean %s' % object1)
        self.refresh_model()
 ...
 #       mol = AllChem.MolFromMolFile('test.mol',removeHs=False)
    ...
    def examine_main(self, object):
        ...
        for i, matom in enumerate(main_atom):
            ...
            elif matom.GetSymbol() == 'S' and len(nsymbols) == 3:  
                types['S_3n'].append(matom.GetIdx() + 1)
            elif matom.GetSymbol() == 'S' and len(nsymbols) == 4:  
                types['S_4n'].append(matom.GetIdx() + 1)
            elif matom.GetSymbol() == 'F' and len(nsymbols) == 1:
                types['F_1n'].append(matom.GetIdx() + 1)
            elif matom.GetSymbol() == 'P' and len(nsymbols) == 1:
                types['P_1n'].append(matom.GetIdx() + 1)
            elif matom.GetSymbol() == 'P' and len(nsymbols) == 2:
                types['P_2n'].append(matom.GetIdx() + 1)
            elif matom.GetSymbol() == 'P' and len(nsymbols) == 3:
                types['P_3n'].append(matom.GetIdx() + 1)
            elif matom.GetSymbol() == 'P' and len(nsymbols) == 4:
                types['P_4n'].append(matom.GetIdx() + 1)
